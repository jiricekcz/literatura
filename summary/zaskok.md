# Záskok - Shrnutí charakteristiky uměleckého textu

## Literárněhistorický kontext

|                Část zkoušky | Odpověď                                                                                                                                              | Poznámka                                         |
| --------------------------: | ---------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------- |
|     Kontext autorovy tvorby | Satirická komedie jako všechny ostatní díla divadla. Drobně odlišný může být třeba Cimrman v říši hudby, kde je seminář velmi krátký.                | Hodí se cca 2 další konkrétní díla               |
|           Literární kontext | Satira v době komunismu; Bohumil Hrabal (Ostře sledované vlaky, Obsluhoval jsem anglického krále); Komunistický svině; Karel Kryl (Veličenstvo kat); | Prý 6 jmen autorů, ale to zní jako BS tbh        |
| Kulturně historický kontext | Za dob komunismu u nás. Díla na první pohled nepolitická tak neměla problém vyjít.                                                                   | Jediná zajímavá část, ale musí být velmi stručně |
...
|                              Téma | Nepovedené zpracování nové divadelní hry                                              | Ústřední myšlenka díla - jedna věta (můžeš vztáhnout na ukázku)                                                                                           |
|                            Motivy | Kult osobnosti, divadlo, neschopnost, dědění                                          | Jednotlivá slova nebo slovní spojení. Může jich být více. Popiš které se vyskytují v ukázce.                                                              |
|                       Časoprostor | Přelom 19. a 20. století na chatě Vavrochových/Machových                              | Pokud se dílo odhrává ve více časech/prostorech, můžeš zmínit, který je v ukázce. Pokud nevíš, drž hubu.                                                  |
|      Kompoziční výstavba - vnější | Seminář a hra                                                                         | Dělení do kapitol atd.                                                                                                                                    |
|     Kompoziční výstavba - vnitřní | [Chronologická] při hře. Seminář nemá děj - [rámcová]                                 | Časová kompozice děje - [retrospektiva][retrospektivní]/[chronologičnost][chronologická]/[rámcová][kompozice]                                             |
|                    Literární druh | [Drama]                                                                               | [Epika]/[Lyrika]/[Drama] - můžeš na ukázce ukázat proč                                                                                                    |
|                    Literární žánr | Satirická [komedie]                                                                   | [Román]/[Komedie]/[Balada] - při neshodě lze vést diskuzi                                                                                                 |
...
|                           Postavy | Přednášející v semináři - cimrmanologové, vysvětlují koncepty později použité v díle; | Pár (<5) hlavních postav a jejich charakteristika. Tuto charakteristiku lze ukázat na ukázce.                                                             |
|                      Typy promluv | [Dialog]                                                                              | [Monolog]/[Dialog] je typ na základě počtu postav [Přímá řeč]/[Polopřímá řeč]/[Nepřímá řeč]/[Neznačená přímá řeč] je na základě formy. !Ukázat na ukázce! |
