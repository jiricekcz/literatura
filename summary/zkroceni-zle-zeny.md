# Zkrocení zlé ženy - Shrnutí charakteristiky uměleckého textu

## Literárněhistorický kontext

|                Část zkoušky | Odpověď                                                                                                                                       | Poznámka                                         |
| --------------------------: | --------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------- |
|     Kontext autorovy tvorby | [komedie]. Psal hlavně [tragédie] nebo třeba sonety.                                                                                          | Hodí se cca 2 další konkrétní díla               |
...
|                              Téma | Zlá dcera kupce je nucena se provdát před mladší sestrou, čímž je následně zkrocena                                      | Ústřední myšlenka díla - jedna věta (můžeš vztáhnout na ukázku)                                                                                           |
|                            Motivy | Láska, chamtivost, svatba, předstírání                                                                                   | Jednotlivá slova nebo slovní spojení. Může jich být více. Popiš které se vyskytují v ukázce.                                                              |
|                       Časoprostor | Město Padova v Itálii na přelomu 16. a 17. století. Nemá vliv na děj.                                                    | Pokud se dílo odhrává ve více časech/prostorech, můžeš zmínit, který je v ukázce. Pokud nevíš, drž hubu.                                                  |
|      Kompoziční výstavba - vnější | 5 dějství                                                                                                                | Dělení do kapitol atd.                                                                                                                                    |
...
|                           Postavy | Kateřina - zlá, hádavá, hrubá, tvrdohlavá; Bianca - hodná krásná; Petruchio - bere si Kateřinu; Lucentio - získá Biancus | Pár (<5) hlavních postav a jejich charakteristika. Tuto charakteristiku lze ukázat na ukázce.                                                             |
|                      Typy promluv | Hlavně [dialog]                                                                                                          | [Monolog]/[Dialog] je typ na základě počtu postav [Přímá řeč]/[Polopřímá řeč]/[Nepřímá řeč]/[Neznačená přímá řeč] je na základě formy. !Ukázat na ukázce! |
