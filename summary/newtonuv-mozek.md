# Newtonův mozek - Shrnutí charakteristiky uměleckého textu

## Literárněhistorický kontext

|                Část zkoušky | Odpověď                                                                                                                                                                                     | Poznámka                                         |
| --------------------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------- |
|     Kontext autorovy tvorby | Tématicky scifi, romanneto - podobně jako jeho ostatní díla (svatý Xaveirus)                                                                                                                | Hodí se cca 2 další konkrétní díla               |
...
|                              Téma | Triky, cestování časem, odpor k válce                                                      | Ústřední myšlenka díla - jedna věta (můžeš vztáhnout na ukázku)                                                                                           |
|                            Motivy | Věda, válka, sci-fi, tajemství, historie                                                   | Jednotlivá slova nebo slovní spojení. Může jich být více. Popiš které se vyskytují v ukázce.                                                              |
|                       Časoprostor | Několik měsíců po bitvě u Hradce Králové 1866. Pražský zámek Kinských a vesnice Nechanice. | Pokud se dílo odhrává ve více časech/prostorech, můžeš zmínit, který je v ukázce. Pokud nevíš, drž hubu.                                                  |
|      Kompoziční výstavba - vnější | Rozdělení na kapitoly                                                                      | Dělení do kapitol atd.                                                                                                                                    |
...
|                           Postavy | Vypravěč - Jakub Arbes, vědecky založený; Přítel - voják, kouzelník                        | Pár (<5) hlavních postav a jejich charakteristika. Tuto charakteristiku lze ukázat na ukázce.                                                             |
|                      Typy promluv | [Přímá řeč]                                                                                | [Monolog]/[Dialog] je typ na základě počtu postav [Přímá řeč]/[Polopřímá řeč]/[Nepřímá řeč]/[Neznačená přímá řeč] je na základě formy. !Ukázat na ukázce! |
|                  Veršová výstavba | Není, je to próza                                                                          | Vychází z ukázky. Pouze u poezii. Rýmové schéma, počet strof a veršů ve strofě.                                                                           |
